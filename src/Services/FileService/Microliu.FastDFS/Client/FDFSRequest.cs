    ...
    internal class FDFSRequest
    {
        ...
        public async Task<T> GetResponseAsync<T>() where T: IFDFSResponse, new ()
        {
            try
            {
                ...
                //foreach (var item in headerBuffer.Array)
                //{
        ...
        {
            Console.WriteLine($"{DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")}:Status:{responseHeader.Status}");
            Console.WriteLine($"{DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")}:Command:{responseHeader.Command}");
            Console.WriteLine($"{DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")}:Length:{responseHeader.Length}");
                ;
